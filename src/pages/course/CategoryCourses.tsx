...
const CategoryCourses = () => {
  ...
  }, [currentPage, searchQuery, levelFilter, sortBy, decodedCategory]);
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2">
            {decodedCategory.replace("-", " ")} Courses
          </h1>
          <p className="text-muted-foreground">
            Explore our {decodedCategory.toLowerCase().replace("-", " ")} course
            collection
          </p>
        </div>
          ...
          <CardContent className="p-6">
            <div className="flex flex-col space-y-4 lg:flex-row lg:items-center lg:space-y-0 lg:space-x-4">
              ...
              <div className="relative flex-1 max-w-md">
                ...
                <Input
                  placeholder={`Search ${decodedCategory.toLowerCase()} courses...`}
                  value={searchQuery}
          ...
          <>
            <div className="mb-4">
              <p className="text-sm text-muted-foreground">
                {totalCourses} course{totalCourses !== 1 ? "s" : ""} found in{" "}
                {decodedCategory}
              </p>
            </div>
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              <p className="text-muted-foreground mb-4">
                No {decodedCategory.toLowerCase()} courses found matching your
                criteria
              </p>
              <Button
                onClick={() => {
